    ...
    try{
        ...
        if(ack.equals("2") == true){
            ...
            if(entrega != null){
                ...
                for(Message msg2 : messages)
                    if(msg2.getResource() == entrega.getResource()){
                        ...
                        Socket clientSocket = new Socket("200.9.84.192", 6520+msg2.getProcess());
            ...
            if(pid != messagePid && using[messageRid-1] == 1){
                ...
                Socket clientSocket = new Socket("200.9.84.192", 6520+messagePid);
                DataOutputStream outToServer = new DataOutputStream(clientSocket.getOutputStream());
            ...
            try{
                ...
                while(true){
                    ...
                    if(flag == false && using[Integer.parseInt(resourceId) - 1] != 1){
                        ...
                        for(i = 0; i < 3; i++){
                            Socket clientSocket = new Socket("200.9.84.192", 6520+i);
                            DataOutputStream outToServer = new DataOutputStream(clientSocket.getOutputStream());
